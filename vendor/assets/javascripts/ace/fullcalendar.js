...
function EventManager(options) { // assumed to be a calendar
	...
	// Returns an array of events as to when the helpers hours occur in the given view.
	...
	function getBusinessHoursEvents() {
		...
		if (optionVal) {
			if (typeof optionVal === 'object') {
				// option value is an object that can override the default helpers hours
				eventInput = $.extend({}, defaultVal, optionVal);
			}
			else {
				// option value is `true`. use default helpers hours
...
$.extend(Grid.prototype, {
	...
	/* Fill System (highlight, background events, helpers hours)
	------------------------------------------------------------------------------------------------------------------*/
...
$.extend(Grid.prototype, {
	...
	// Generates an array of classNames to be used for the rendering helpers hours overlay. Called by the fill system.
...
$.extend(TimeGrid.prototype, {
	...
	// Repositions helpers hours segs too, so not just for events. Maybe shouldn't be here.
