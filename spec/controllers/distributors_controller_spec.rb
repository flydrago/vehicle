...
RSpec.describe DistributorsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested distributor as @distributor" do
      distributor = Distributor.create! valid_attributes
      get :show, params: {id: distributor.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested distributor as @distributor" do
      distributor = Distributor.create! valid_attributes
      get :edit, params: {id: distributor.to_param}, session: valid_session
      expect(assigns(:distributor)).to eq(distributor)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Distributor" do
        expect {
          post :create, params: {distributor: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved distributor as @distributor" do
        post :create, params: {distributor: invalid_attributes}, session: valid_session
        expect(assigns(:distributor)).to be_a_new(Distributor)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested distributor" do
        distributor = Distributor.create! valid_attributes
        put :update, params: {id: distributor.to_param, distributor: new_attributes}, session: valid_session
        distributor.reload
      ...
      it "assigns the requested distributor as @distributor" do
        distributor = Distributor.create! valid_attributes
        put :update, params: {id: distributor.to_param, distributor: valid_attributes}, session: valid_session
        expect(assigns(:distributor)).to eq(distributor)
      end
    ...
    context "with invalid params" do
      it "assigns the distributor as @distributor" do
        distributor = Distributor.create! valid_attributes
        put :update, params: {id: distributor.to_param, distributor: invalid_attributes}, session: valid_session
        expect(assigns(:distributor)).to eq(distributor)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested distributor" do
      distributor = Distributor.create! valid_attributes
      expect {
        delete :destroy, params: {id: distributor.to_param}, session: valid_session
      }.to change(Distributor, :count).by(-1)
    end
    ...
    it "redirects to the distributors list" do
      distributor = Distributor.create! valid_attributes
      delete :destroy, params: {id: distributor.to_param}, session: valid_session
      expect(response).to redirect_to(distributors_url)
    end
  end
