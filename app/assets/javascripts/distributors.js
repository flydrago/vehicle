...
$(function () {
    ...
    distributor_DataTable = $('#distributor_table').DataTable({
        /**
        ...
        bServerSide: true,
        stateSave: true,
        sAjaxSource: $('#distributor_table').data('source'),
...
function search() {
    ...
    distributor_DataTable.ajax.url(request_url).load()
}
